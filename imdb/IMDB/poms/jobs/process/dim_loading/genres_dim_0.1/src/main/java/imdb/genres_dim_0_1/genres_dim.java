 ...
 * @status
 */
public class genres_dim implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "genres_dim.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(genres_dim.class);
	...
	private final String jobName = "genres_dim";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(genres_dim.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_IMDB_genres_dim = new byte[0];
		static byte[] commonByteArray_IMDB_genres_dim = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDB_genres_dim.length) {
					if (length < 1024 && commonByteArray_IMDB_genres_dim.length == 0) {
						commonByteArray_IMDB_genres_dim = new byte[1024];
					} else {
						commonByteArray_IMDB_genres_dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDB_genres_dim, 0, length);
				strReturn = new String(commonByteArray_IMDB_genres_dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDB_genres_dim, 0, length);
				strReturn = new String(commonByteArray_IMDB_genres_dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDB_genres_dim) {
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "oP09Na_" + subJobPidCounter.getAndIncrement());
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
								...
								, "row1", "tDBInput_1", "\"merged_title_basics\"", "tMysqlInput", "tMap_2", "tMap_2",
								"tMap"
...
// ###############################      
				...
				if (runStat.updateStatAndLog(execStat, enableLogStash, resourceMap, iterateId, "row1", 2, 0,
						"tDBInput_1", "\"merged_title_basics\"", "tMysqlInput", "tMap_2", "tMap_2", "tMap", "output")) {
					talendJobLogProcess(globalMap);
				}
...
// ###############################
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					if (runStat.update(execStat, enableLogStash, iterateId, 1, 1
							...
							, "row2", "tAggregateRow_1_AGGIN", "tAggregateRow_1_AGGIN", "tAggregateIn", "tMap_1",
							"tMap_1", "tMap"
...
// ###############################      
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "AGuhiV_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final genres_dim genres_dimClass = new genres_dim();

		int exitCode = genres_dimClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'genres_dim' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'genres_dim' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_xlEvkI_GEe6Qgqt0RnFXeQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-04T03:48:46.100384700Z");
		...
		try {
			...
			java.io.InputStream inContext = genres_dim.class.getClassLoader()
					.getResourceAsStream("imdb/genres_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = genres_dim.class.getClassLoader()
		...
		log.info("TalendJob: 'genres_dim' - Started.");
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : genres_dim");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'genres_dim' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 213537 characters generated by Talend Cloud Data Fabric on the 3 December
 * 2023 at 10:48:46 PM GMT-05:00
 ************************************************************************************************/