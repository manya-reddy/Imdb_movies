 ...
 * @status
 */
public class location_dim implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "location_dim.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(location_dim.class);
	...
	private final String jobName = "location_dim";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(location_dim.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
		final static byte[] commonByteArrayLock_IMDB_location_dim = new byte[0];
		static byte[] commonByteArray_IMDB_location_dim = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDB_location_dim.length) {
					if (length < 1024 && commonByteArray_IMDB_location_dim.length == 0) {
						commonByteArray_IMDB_location_dim = new byte[1024];
					} else {
						commonByteArray_IMDB_location_dim = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDB_location_dim, 0, length);
				strReturn = new String(commonByteArray_IMDB_location_dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDB_location_dim, 0, length);
				strReturn = new String(commonByteArray_IMDB_location_dim, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDB_location_dim) {
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "Ztj1of_" + subJobPidCounter.getAndIncrement());
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					...
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`region_sk` INT(10)  ,`name` VARCHAR(100)  ,`region` VARCHAR(255)  ,`alpha_2` VARCHAR(25)  ,`sub_region` VARCHAR(31)  ,`DI_CreatedDate` DATETIME  not null ,`DI_JobID` VARCHAR(12)   not null ,primary key(`region_sk`))");
					if (log.isDebugEnabled())
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "region_dim"
						+ "` (`region_sk`,`name`,`region`,`alpha_2`,`sub_region`,`DI_CreatedDate`,`DI_JobID`) VALUES (?,?,?,?,?,?,?)";
...
// # Output table : 'out1'
									...
									out1_tmp.alpha_2 = row1.alpha_2;
									out1_tmp.sub_region = row1.sub_region;
...
// Start of branch "out1"
							if (out1 != null) {
								...
								if (out1.alpha_2 == null) {
									pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(4, out1.alpha_2);
								}

								if (out1.sub_region == null) {
									pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
								} else {
									pstmt_tDBOutput_1.setString(5, out1.sub_region);
								}
								...
								if (out1.DI_JobID == null) {
									...
									pstmt_tDBOutput_1.setString(7, out1.DI_JobID);
								}
...
// ###############################      
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "LyEHpI_" + subJobPidCounter.getAndIncrement());
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "HUKZUS_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final location_dim location_dimClass = new location_dim();

		int exitCode = location_dimClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'location_dim' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'location_dim' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_9CJgwI_PEe6IsadS5-rvwQ");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-04T03:53:03.733691Z");
		...
		try {
			...
			java.io.InputStream inContext = location_dim.class.getClassLoader()
					.getResourceAsStream("imdb/location_dim_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = location_dim.class.getClassLoader()
		...
		log.info("TalendJob: 'location_dim' - Started.");
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : location_dim");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'location_dim' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 173965 characters generated by Talend Cloud Data Fabric on the 3 December
 * 2023 at 10:53:03 PM GMT-05:00
 ************************************************************************************************/