...
package imdb.date_dim_loading_0_1;
...
/**
 * Job: date_dim_loading Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class date_dim_loading implements TalendJob {
	static {
		System.setProperty("TalendJob.log", "date_dim_loading.log");
	}

	private static org.apache.logging.log4j.Logger log = org.apache.logging.log4j.LogManager
			.getLogger(date_dim_loading.class);
	...
	public class ContextProperties extends PropertiesWithType {
		...
		public void synchronizeContext() {
			...
			if (startDate != null) {
				...
				String value_startDate = "1880-01-03 12:19:04";
	...
	private final String jobName = "date_dim_loading";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					date_dim_loading.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(date_dim_loading.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class oStruct implements routines.system.IPersistableRow<oStruct> {
		final static byte[] commonByteArrayLock_IMDB_date_dim_loading = new byte[0];
		static byte[] commonByteArray_IMDB_date_dim_loading = new byte[0];
		...
		public Integer Motnh;

		public Integer getMotnh() {
			return this.Motnh;
		}

		public Boolean MotnhIsNullable() {
			return true;
		}

		public Boolean MotnhIsKey() {
			return false;
		}

		public Integer MotnhLength() {
			return null;
		}

		public Integer MotnhPrecision() {
			return null;
		}

		public String MotnhDefault() {

			return null;

		}

		public String MotnhComment() {

			return "";

		}

		public String MotnhPattern() {

			return "";

		}

		public String MotnhOriginalDbColumnName() {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_IMDB_date_dim_loading.length) {
					if (length < 1024 && commonByteArray_IMDB_date_dim_loading.length == 0) {
						commonByteArray_IMDB_date_dim_loading = new byte[1024];
					} else {
						commonByteArray_IMDB_date_dim_loading = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_IMDB_date_dim_loading, 0, length);
				strReturn = new String(commonByteArray_IMDB_date_dim_loading, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_IMDB_date_dim_loading, 0, length);
				strReturn = new String(commonByteArray_IMDB_date_dim_loading, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_IMDB_date_dim_loading) {
		...
		public String toString() {
			...
			sb.append(",Motnh=" + String.valueOf(Motnh));
			sb.append("]");
	...
	public void tRowGenerator_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "wLYYje_" + subJobPidCounter.getAndIncrement());
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				util_tLogRow_1.addRow(new String[] { "datesk", "date", "Day", "Day_Str", "Month_Str", "Season", "Year",
						"DI_CreatedDate", "DI_JobID", "Motnh", });
...
///////////////////////    			
				...
				if (log.isDebugEnabled()) {
					class BytesLimit65535_tDBOutput_1 {
						public void limitLog4jByte() throws Exception {
							...
							log4jParamters_tDBOutput_1.append(" | ");
							log4jParamters_tDBOutput_1.append("DBNAME" + " = " + "\"imdb\"");
							log4jParamters_tDBOutput_1.append(" | ");
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					...
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`datesk` INT(10)  ,`date` DATE ,`Day` INT(2)  ,`Day_Str` VARCHAR(9)  ,`Month_Str` VARCHAR(9)  ,`Season` VARCHAR(8)  ,`Year` INT(4)  ,`DI_CreatedDate` DATETIME ,`DI_JobID` VARCHAR(10)  ,primary key(`datesk`))");
					if (log.isDebugEnabled())
				...
				String insert_tDBOutput_1 = "INSERT INTO `" + "date_dimension"
						+ "` (`datesk`,`date`,`Day`,`Day_Str`,`Month_Str`,`Season`,`Year`,`DI_CreatedDate`,`DI_JobID`) VALUES (?,?,?,?,?,?,?,?,?)";
...
// ###############################
				...
				int nb_max_row_tRowGenerator_1 = 89898;
...
// # Output table : 'o'
						...
						o_tmp.Day_Str = TalendDate.formatDate("EEEE", row1.colDate);
						...
						o_tmp.DI_JobID = pid;
						o_tmp.Motnh = TalendDate.getPartOfDate("MM", row1.colDate);
						o = o_tmp;
...
// # Output table : 'datedim_to_db'
						...
						datedim_to_db_tmp.Day_Str = TalendDate.formatDate("EEEE", row1.colDate);
...
///////////////////////		
						...
						if (o.Day_Str != null) { //
							row_tLogRow_1[3] = String.valueOf(o.Day_Str);

						} //

						if (o.Month_Str != null) { //
							row_tLogRow_1[4] = String.valueOf(o.Month_Str);

						} //

						if (o.Season != null) { //
							row_tLogRow_1[5] = String.valueOf(o.Season);

						} //

						if (o.Year != null) { //
							row_tLogRow_1[6] = String.valueOf(o.Year);

						} //

						if (o.DI_CreatedDate != null) { //
							row_tLogRow_1[7] = FormatterUtils.format_Date(o.DI_CreatedDate, "dd-MM-yyyy");

						} //

						if (o.DI_JobID != null) { //
							row_tLogRow_1[8] = String.valueOf(o.DI_JobID);

						} //

						if (o.Motnh != null) { //
							row_tLogRow_1[9] = String.valueOf(o.Motnh);
...
// Start of branch "datedim_to_db"
					if (datedim_to_db != null) {
						...
						if (datedim_to_db.Day_Str == null) {
							pstmt_tDBOutput_1.setNull(4, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(4, datedim_to_db.Day_Str);
						}

						if (datedim_to_db.Month_Str == null) {
							pstmt_tDBOutput_1.setNull(5, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(5, datedim_to_db.Month_Str);
						}

						if (datedim_to_db.Season == null) {
							pstmt_tDBOutput_1.setNull(6, java.sql.Types.VARCHAR);
						} else {
							pstmt_tDBOutput_1.setString(6, datedim_to_db.Season);
						}

						if (datedim_to_db.Year == null) {
							pstmt_tDBOutput_1.setNull(7, java.sql.Types.INTEGER);
						} else {
							pstmt_tDBOutput_1.setInt(7, datedim_to_db.Year);
						}
						...
						if (datedim_to_db.DI_JobID == null) {
							...
							pstmt_tDBOutput_1.setString(9, datedim_to_db.DI_JobID);
						}
...
///////////////////////    			
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "lBUmTT_" + subJobPidCounter.getAndIncrement());
	...
	public static void main(String[] args) {
		final date_dim_loading date_dim_loadingClass = new date_dim_loading();

		int exitCode = date_dim_loadingClass.runJobInTOS(args);
		if (exitCode == 0) {
			log.info("TalendJob: 'date_dim_loading' - Done.");
		}
	...
	public int runJobInTOS(String[] args) {
		...
		getjobInfo();
		log.info("TalendJob: 'date_dim_loading' - Start.");
		...
		org.slf4j.MDC.put("_jobRepositoryId", "_f3WTcImNEe6t-4cn4gX0qA");
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-03T17:34:51.972369600Z");
		...
		try {
			...
			java.io.InputStream inContext = date_dim_loading.class.getClassLoader()
					.getResourceAsStream("imdb/date_dim_loading_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = date_dim_loading.class.getClassLoader()
		...
		log.info("TalendJob: 'date_dim_loading' - Started.");
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : date_dim_loading");
		}
		if (enableLogStash) {
		...
		log.info("TalendJob: 'date_dim_loading' - Finished - status: " + status + " returnCode: " + returnCode);
...
/************************************************************************************************
 * 145022 characters generated by Talend Cloud Data Fabric on the 3 December
 * 2023 at 12:34:51 PM GMT-05:00
 ************************************************************************************************/