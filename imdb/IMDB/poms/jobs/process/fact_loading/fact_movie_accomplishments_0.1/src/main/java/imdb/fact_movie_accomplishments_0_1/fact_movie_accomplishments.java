...
public class fact_movie_accomplishments implements TalendJob {
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "ykIo17_" + subJobPidCounter.getAndIncrement());
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try (java.sql.Statement stmtCreate_tDBOutput_1 = conn_tDBOutput_1.createStatement()) {
					...
					stmtCreate_tDBOutput_1.execute("CREATE TABLE `" + tableName_tDBOutput_1
							+ "`(`movie_accomplishments_fact_sk` INT(0)   not null ,`movie_sk` INT(10)  ,`tconst` VARCHAR(15)  ,`startYear` VARCHAR(4)  ,`averageRating` DOUBLE(22,2)  ,`numVotes` INT(10)  ,`Total_Gross` INT(10)  ,`runtimeMinutes` VARCHAR(10)  ,`DI_CreatedDate` DATETIME  not null ,`DI_JobID` VARCHAR(15)   not null ,primary key(`movie_accomplishments_fact_sk`))");
					if (log.isDebugEnabled())
...
// ###############################      
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "PYjQnm_" + subJobPidCounter.getAndIncrement());
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "GVHqtL_" + subJobPidCounter.getAndIncrement());
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "adfwo6_" + subJobPidCounter.getAndIncrement());
...
// ###############################      
	...
	public void talendJobLogProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		org.slf4j.MDC.put("_subJobPid", "qfd8rM_" + subJobPidCounter.getAndIncrement());
	...
	public int runJobInTOS(String[] args) {
		...
		org.slf4j.MDC.put("_compiledAtTimestamp", "2023-12-04T04:21:13.767885800Z");
...
/************************************************************************************************
 * 390169 characters generated by Talend Cloud Data Fabric on the 3 December
 * 2023 at 11:21:13 PM GMT-05:00
 ************************************************************************************************/